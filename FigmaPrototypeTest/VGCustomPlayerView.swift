...
class VGCustomPlayerView: VGPlayerView {
    ...
    let bottomProgressView : UIProgressView = {
        ...
        progress.tintColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
...
//        self.closeButton.setImage(#imageLiteral(resourceName: "nav_back"), for: .normal)
        ...
        rateButton.tintColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
        ...
        mirrorFlipButton.tintColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
        ...
        subtitlesLabel.textColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
        subtitlesLabel.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.2475165563)
